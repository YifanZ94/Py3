...
class HighPowerStepperDriver:
    ...
    def __init__(self, spi, cs, baudrate=100000):
        ...
        import spi_device as spi_device  # pylint: disable=import-outside-toplevel

        self.spi = spi_device.SPIDevice(spi, cs, baudrate=baudrate)
...
### Writes the specified value to a register
    ...
    def writeReg(self, address, data):
        ...
        self.spi.write([message[0], message[1]])
