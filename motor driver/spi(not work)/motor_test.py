...
#import os
#os.getcwd()
#os.chdir('C:\Users\user\Desktop\py code\Python3\MMC5603')
...
sd_cs = digitalio.DigitalInOut(board.C0)
sd = StepperDriver_py3.HighPowerStepperDriver(spi, sd_cs)
